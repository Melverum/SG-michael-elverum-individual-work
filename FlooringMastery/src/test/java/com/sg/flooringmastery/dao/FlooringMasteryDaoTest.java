...
public class FlooringMasteryDaoTest {
    ...
    public void testGetOrdersByDate() throws Exception {
        ...
        List<Order> orders = dao.getOrdersByDate(LocalDate.parse("01-01-2000", formatted));
        assertEquals(dao.getOrdersByDate(LocalDate.parse("01-01-2000", formatted)).size(), orders.size());
    }
    ...
    public void testRemoveOrder() throws Exception {
       ...
       dao.removeOrder(removeOrder, LocalDate.parse("01-01-2000", formatter));
    ...
    public void testAddToFile() throws Exception {
        ...
        order.setCustomerName("Alex Forsythe");
        order.setArea(new BigDecimal("400.00"));
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("MM-dd-yyyy");
       List<Order> before = dao.getOrdersByDate(LocalDate.parse("01-01-2000", formatter));
       dao.addToFile(order, LocalDate.parse("01-01-2000", formatter));
       List<Order> after = dao.getOrdersByDate(LocalDate.parse("01-01-2000", formatter));
